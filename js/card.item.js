        ...
        <div class="px-10">
          ...
          <div class="flex flex-row m-5 justify-between">
            <div class="flex">
              ...
              <div class="px-5">
                <p class="text-2xl">${item.author.name ? item.author.name : 'Not Found'}</p>
                <p class="text-2xl">${item.author.published_date ? item.author.published_date.slice(0,10) : 'Not Found'}</p>
              </div>
            </div>
